...
/* //spi
av_dict_set(&options,"offset_x","0",0); //spi
//The distance from the top edge of the screen or desktop
av_dict_set(&options,"offset_y","0",0); //spi
//Video frame size. The default is to capture the full screen
av_dict_set(&options,"video_size","1920x1080",0); //spi
//av_dict_set(&options,"video_size","3840x1080",0); //spi
*/
...
pCodecCtx_Video->width, pCodecCtx_Video->height, AV_PIX_FMT_YUV420P, //spi
...
//char * psDevName = dup_wchar_to_utf8(L"audio=Microphone (Fast Track)"); //spi
...
const char *outFileName = "test.mp4"; //original
//const char *outFileName = "test.avi"; //spi
